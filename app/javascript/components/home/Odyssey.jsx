...
const Odyssey = ({ coverUrl }) => {
  const coverImageStyle = {
    backgroundImage: `url(${coverUrl})`
  }
  return (
    <div className="chapter">
    <div id="odyssey-cover" style={coverImageStyle}></div>
    <h2>The Odyssey | Book I</h2>
    ...
    and lie in two halves, the one looking West and the other East.
    He had gone there to accept a hecatomb of sheep and oxen, and was enjoying
    himself at his festival; but the other gods met in the house of Olympian Jove,
    and the sire of gods and men spoke first. At that moment he was thinking of
    Aegisthus, who had been killed by Agamemnon’s son Orestes; so he said to
    the other gods:
    </p>
    ...
    footstool also for her feet, and he set another seat near her for
    ...
    for Temesa with a cargo of iron, and I shall bring
    back copper. As for my ship, it lies over yonder off the open country away from
    the town, in the harbour Rheithron under the wooded mountain Neritum.
    ...
    point blank say that she will not marry, nor yet bring
    matters to an end; so they are making havoc of my estate, and before long will
    do so also with myself.”
    </p>
    ...
    that supported the roof of the cloisters with a staid
    maiden on either side of her. She held a veil, moreover, before her face, and
    ...
    clamorous throughout the covered cloisters, and prayed
    ...
    abode. Telemachus’s room was high up
    in a tower that looked on to the outer court;
    ...
    now lighted Telemachus to his room, and she loved him better than any of the
    ...
    shirt he gave it to the good old woman, who
    ...
    home by means of the strap. But Telemachus as he lay covered with
